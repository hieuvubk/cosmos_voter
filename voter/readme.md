...
[Github Pages Setings](https://github.com/(alice/voter/settings/)

After you do that you can visit your chain's UI at:

https://alice.github.io/voter
...
In order for Docker images and Raspberry Pi images to build successfully, please add your docker hub credentials as [secrets](https://github.com/alice/voter/settings/secrets/actions)
